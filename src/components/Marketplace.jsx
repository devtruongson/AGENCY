...
export default function Marketplace() {
    ...
    const tabs = [
        {
            id: "accounts",
            label: t("marketplace.tabs.accounts"),
            icon: "account_circle",
        },
        ...
        {
            id: "profiles",
            label: t("marketplace.tabs.profiles"),
            icon: "badge",
        },
        {
            id: "verification",
            label: t("marketplace.tabs.verification"),
            icon: "verified",
        },
    ];
...
const Card = ({ children, highlighted = false }) => (
    <div
        className={`w-[85vw] max-w-[350px] md:w-[400px] md:max-w-none bg-black/80 backdrop-blur-xl border ${highlighted ? "border-primary shadow-[0_0_50px_rgba(234,88,12,0.2)]" : "border-white/10"} rounded-[2.5rem] p-8 md:p-10 h-full flex flex-col relative overflow-hidden group hover:border-primary/50 transition-colors`}
    >
        {highlighted && (
            ...
            {accounts.map((account, index) => (
                <SwiperSlide key={index} className="!w-auto">
                    <Card>
                        ...
                        <h3 className="text-white text-3xl font-black mb-2 leading-none">
                            {account.name}
                        </h3>
                ...
                <SwiperSlide key={index} className="!w-auto">
                    <Card highlighted={pkg.highlighted}>
                        <div className="text-center mb-8">
                            <span className="text-primary text-5xl font-black block mb-2">
                                {pkg.price}
                            </span>
            ...
            {tiers.map((tier, index) => (
                <SwiperSlide key={index} className="!w-auto">
                    <Card>
                        ...
                        <div className="text-center text-primary text-5xl font-black mb-10">
                            {tier.price}
                        </div>
                        <OrderButton t={t} />
                    </Card>
                ...
                <SwiperSlide key={index} className="!w-auto">
                    <Card>
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h3 className="text-white text-xl font-bold leading-none mb-1">
                                    {profile.name}
                                </h3>
...
function VerificationCarousel() {
    const { t } = useTranslation();
    const services = t("marketplace.verification.services", {
        returnObjects: true,
    });
            ...
            {services.map((service, index) => (
                <SwiperSlide key={index} className="!w-auto">
                    <Card highlighted>
                        ...
                        <div className="text-5xl font-black text-white mb-10 tracking-tight">
                            {service.price}
                        </div>
                        <ul className="space-y-3 mb-10">
