    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                "https://publish-mail.fstack.io.vn/send-mail",
                {
                    method: "POST",
                    headers: {
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-surface-dark border-border-dark rounded-xl px-5 py-4 text-white focus:border-primary focus:ring-1 focus:ring-primary transition-all"
                                        placeholder={t(
                                            "contact.form.telegramPlaceholder",
                                        )}
                                        type="text"
                                        required
                                    />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-surface-dark border-border-dark rounded-xl px-5 py-4 text-white focus:border-primary focus:ring-1 focus:ring-primary transition-all"
                                    >
                                        <option value="Managed Ad Packages">
                                            {t(
                                                "contact.form.serviceOptions.managed",
                                            )}
                                        </option>
                                        <option value="Account Rentals">
                                            {t(
                                                "contact.form.serviceOptions.rentals",
                                            )}
                                        </option>
                                        <option value="Asset Marketplace">
                                            {t(
                                                "contact.form.serviceOptions.marketplace",
                                            )}
                                        </option>
                                        <option value="Enterprise Solutions">
                                            {t(
                                                "contact.form.serviceOptions.enterprise",
                                            )}
                                        </option>
                                    </select>
                                </div>
